...
export const FAQSkeleton: React.FC = () => (
  <div className="p-3.5 sm:p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 bg-white/80 dark:bg-slate-900/60 shadow-xs flex items-center justify-between gap-3">
