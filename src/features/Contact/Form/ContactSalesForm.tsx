// src/features/Contact/Form/ContactSalesForm.tsx
...
export const ContactSalesForm: React.FC<ContactSalesFormProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative rounded-2xl border border-slate-800/80 bg-slate-950/70 p-6 sm:p-8 backdrop-blur-xl shadow-2xl shadow-black/40">
