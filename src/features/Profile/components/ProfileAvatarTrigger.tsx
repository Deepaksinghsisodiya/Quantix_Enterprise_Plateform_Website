...
export const ProfileAvatarTrigger: React.FC<ProfileAvatarTriggerProps> = ({
  ...
  return (
    <button
      ...
      className="relative flex items-center justify-center h-9 w-9 sm:h-9.5 sm:w-9.5 rounded-full bg-gradient-to-tr from-[#FF4D00] via-[#FF621F] to-[#E03E00] text-white font-syne text-xs sm:text-sm font-black shadow-sm transition-all duration-200 hover:shadow-md hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-[#FF4D00]/50 ring-2 ring-slate-100 dark:ring-slate-800 cursor-pointer"
    >
