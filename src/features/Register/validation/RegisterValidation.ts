...
export const registerValidationSchema = Yup.object().shape({
  ...
  locations: Yup.string().required('Please select number of locations'),
});

export const step1ValidationSchema = registerValidationSchema;
export const step2ValidationSchema = registerValidationSchema;
