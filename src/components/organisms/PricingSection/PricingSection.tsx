      ...
      <section className="py-24 bg-slate-50/50 border-t border-slate-100" ref={ref} id="pricing">
        <div className="site-container">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-display font-bold tracking-tight text-gray-900 sm:text-4xl">Simple, transparent pricing</h2>
                ...
                <AnimatePresence key={plan.id} mode="wait">
                  ...
                  >
                    <div>
                      ...
                      <h3 className={cn('text-[10px] font-display font-semibold uppercase tracking-wider text-slate-400', plan.mostPopular && 'text-blue-200')}>
                        {plan.name}
                      </h3>
