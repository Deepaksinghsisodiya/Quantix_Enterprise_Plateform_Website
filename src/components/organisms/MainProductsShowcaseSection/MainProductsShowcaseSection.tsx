...
const PLATFORM_MODULES: PlatformModule[] = [
  ...
  },
  {
    ...
    description: "White-label POS, ERP sync, custom SLA, and direct integrations.",
    badge: "Custom APIs",
    href: "/products/custom-service",
    imageSrc: "/images/ss1.jpg",
    imageAlt: "Custom API POS platform dashboard",
    icon: Code2,
  },
  {
  ...
  },
  {
    ...
    imageSrc: "/images/hero_pos_terminal.jpg",
...
const PRODUCT_LINES: ProductLine[] = [
  {
    ...
    topBadge: "Centralized Catalog",
    bottomBadge: "Global Data Rollouts",
    href: "/products/enterprise-pos",
