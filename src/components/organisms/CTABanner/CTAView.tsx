  ...
  return (
    ...
    >
      <div className="site-container px-4 sm:px-6">
        <div className="relative w-full rounded-md overflow-hidden bg-[#080B11] border border-slate-800/80 pt-10 sm:pt-14 lg:pt-20 pb-6 sm:pb-10 lg:pb-20 text-center shadow-2xl">
          {/* Ambient Lighting & High-Tech Backdrop Grid */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-212.5 h-87.5 bg-linear-to-b from-[#FF4F00]/15 via-orange-500/4 to-transparent blur-[120px] pointer-events-none z-0" />
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-150 h-55 bg-linear-to-t from-amber-500/5 to-transparent blur-[100px] pointer-events-none z-0" />
          ...
          <div className="relative z-10 px-4 sm:px-6">
            ...
            >
              ...
              <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-3.5 py-1 rounded-md bg-orange-500/10 border border-orange-500/25 text-[9.5px] sm:text-[11px] font-black uppercase tracking-wider sm:tracking-widest text-[#FF4F00] mb-3.5 sm:mb-5 shadow-2xs max-w-full">
              ...
              <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-syne font-black text-white tracking-tight leading-[1.18] sm:leading-[1.12] px-1 sm:px-0">
                {heading}{' '}
                <span className="text-transparent bg-clip-text bg-linear-to-r from-[#FF4F00] via-[#FF6B2B] to-amber-400 block sm:inline">
                  {headingAccent}
                </span>
              </h2>
              ...
              <div className="flex flex-wrap items-center justify-center gap-1.5 sm:gap-2.5 mt-5 sm:mt-7">
                {chips.map((chip) => (
                  <div
                    key={chip.id}
                    className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-md border border-slate-800/90 bg-slate-900/80 backdrop-blur-md text-[10px] sm:text-xs font-mono font-medium text-slate-300 shadow-xs"
                  >
