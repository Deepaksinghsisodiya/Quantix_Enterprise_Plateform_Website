...
const integrations: Integration[] = [
  ...
  { id: 'square', name: 'Square', category: 'PAYMENTS', color: '#000000', logo: '/brands/integrations/square.svg' },
  { id: 'doordash', name: 'DoorDash', category: 'DELIVERY', color: '#FF3008', logo: '/brands/integrations/doordash.svg' },
  { id: 'ubereats', name: 'Uber Eats', category: 'DELIVERY', color: '#06C167', logo: '/brands/integrations/ubereats.svg' },
];
    ...
    <section className="py-16 sm:py-24 bg-white dark:bg-slate-950 text-slate-900 dark:text-white overflow-hidden relative select-none transition-colors">
      <div className="site-container mb-10 sm:mb-14 text-center relative z-10">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-syne font-semibold text-slate-900 dark:text-white tracking-tight leading-tight max-w-3xl mx-auto">
          Connect Quantix With Your <span className="text-primary dark:text-primary-light">Retail Ecosystem</span>
        </h2>

        <p className="mt-3 text-xs sm:text-base text-slate-600 dark:text-slate-400 font-medium max-w-xl mx-auto leading-relaxed">
          Automate barcode registers, payment terminals, web storefronts, and daily accounting settlements automatically.
        </p>
      </div>
