  ...
  categories: [
    {
      ...
      items: [
        ...
        { title: 'Cloud POS Hub', desc: 'Multi-store cloud analytics', href: '/products/cloud-pos', icon: Cloud, iconColor: 'text-blue-500' },
        { title: 'Enterprise POS', desc: 'Multi-location network controls', href: '/products/enterprise-pos', icon: Server, iconColor: 'text-purple-500' },
      ],
    },
    {
      categoryTitle: 'ORDERING CHANNELS',
      items: [
        { title: 'Online Ordering', desc: 'Branded web menus & pickup', href: '/products/websites', icon: Globe, iconColor: 'text-violet-500' },
        ...
        { title: 'Delivery Dispatch', desc: 'Dispatch queue & driver sync', href: '/features/delivery-management', icon: Truck, iconColor: 'text-red-500' },
      ],
    },
    {
      categoryTitle: 'OPERATIONS & ENTERPRISE',
      items: [
        ...
        { title: 'Digital Menu Boards', desc: 'Dynamic counter screen displays', href: '/features/menu-boards', icon: Monitor, iconColor: 'text-cyan-500' },
...
export const SOLUTIONS_MEGA_CONFIG: MegaMenuSectionData = {
  ...
  categories: [
    {
      categoryTitle: 'RESTAURANT & DINING',
      items: [
        ...
        { title: 'Fast Casual', desc: 'Combo builders & queue timers', href: '/solutions/fast-casual', icon: Layers, iconColor: 'text-blue-500' },
        { title: 'Cafes & Bakeries', desc: 'Drink modifiers & batch costing', href: '/solutions/cafe-bakery', icon: Coffee, iconColor: 'text-amber-700' },
      ],
    },
    {
      categoryTitle: 'RETAIL & ENTERPRISE',
      items: [
        { title: 'Fashion & Apparel', desc: 'Size/color matrix & boutique stock', href: '/solutions/fashion-retail', icon: ShoppingBag, iconColor: 'text-pink-500' },
        { title: 'Grocery & Supermarket', desc: 'Barcode scale & perishable alert', href: '/solutions/grocery', icon: Store, iconColor: 'text-emerald-500' },
        { title: 'Electronics & Tech', desc: 'Serial number sync & warranty', href: '/solutions/electronics', icon: Monitor, iconColor: 'text-sky-500' },
        { title: 'Multi-Store Franchise', desc: 'Central menu push & multi-branch', href: '/solutions/franchise', icon: Server, iconColor: 'text-purple-500' },
      ],
    },
  ],
};
  ...
  categories: [
    {
      ...
      items: [
        ...
        { title: 'Square POS', desc: 'Terminal reader & catalog bridge', href: '/integrations/square', icon: Monitor, iconColor: 'text-sky-500' },
    ...
    {
      categoryTitle: 'DELIVERY DISPATCH',
      items: [
        { title: 'DoorDash Drive', desc: 'Direct kitchen ticket printing', href: '/integrations/doordash', icon: Truck, iconColor: 'text-red-500' },
        { title: 'Uber Eats', desc: 'Zero-tablet kitchen dispatching', href: '/integrations/uber-eats', icon: Utensils, iconColor: 'text-emerald-500' },
      ],
    },
  ],
};
...
export const RESOURCES_MEGA_CONFIG: MegaMenuSectionData = {
  ...
  categories: [
    {
      categoryTitle: 'LEARN & SUPPORT',
      items: [
        { title: 'Frequently Asked Questions', desc: 'Answers to billing, POS & setup', href: '/faq', icon: HelpCircle, iconColor: 'text-amber-500' },
        { title: 'Help Guides & Documentation', desc: 'Terminal & hardware guides', href: '/help', icon: FileText, iconColor: 'text-blue-500' },
        { title: 'Blog & Articles', desc: 'POS insights & industry trends', href: '/blog', icon: BookOpen, iconColor: 'text-purple-500' },
        { title: 'ROI Savings Calculator', desc: 'Calculate your POS cost savings', href: '/roi-calculator', icon: Calculator, iconColor: 'text-emerald-500' },
      ],
    },
    {
      categoryTitle: 'UTILITIES & SPECS',
      items: [
        { title: 'App & Driver Downloads', desc: 'Register app & printer drivers', href: '/downloads', icon: Download, iconColor: 'text-teal-500' },
        { title: 'System Status & API Docs', desc: 'Real-time uptime & API specs', href: '/status', icon: Activity, iconColor: 'text-rose-500' },
        { title: 'Cloud vs Standalone Guide', desc: 'Compare platform license models', href: '/enterprise-vs-standalone', icon: Layers, iconColor: 'text-indigo-500' },
      ],
    },
  ],
};
...
export const COMPANY_MEGA_CONFIG: MegaMenuSectionData = {
  ...
  categories: [
    {
      categoryTitle: 'ABOUT QUANTIX',
      items: [
        { title: 'About Us', desc: 'Learn about our vision and team', href: '/about', icon: Flame, iconColor: 'text-rose-500' },
        { title: 'Careers & Hiring', desc: 'Join our remote international team', href: '/careers', icon: Briefcase, iconColor: 'text-blue-500' },
        { title: 'Press & Media', desc: 'Official brand kit & announcements', href: '/press', icon: Newspaper, iconColor: 'text-purple-500' },
        { title: 'Customer Reviews', desc: 'Read stories from real merchants', href: '/testimonials', icon: Star, iconColor: 'text-amber-500' },
      ],
    },
  ],
};
    ...
    groups: [
      {
        ...
        items: [
          { title: 'About Us', desc: 'Learn about our vision and team', href: '/about', icon: Flame },
          ...
          { title: 'Customer Reviews', desc: 'Read stories from real merchants', href: '/testimonials', icon: Star },
        ],
      },
    ],
  },
