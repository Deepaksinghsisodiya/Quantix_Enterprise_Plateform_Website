...
export const BrandLogo: React.FC<BrandLogoProps> = ({ pathname, onClick }) => {
  ...
  return (
    ...
    >
      <div className="flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-xl bg-linear-to-tr from-primary to-primary-dark text-white shadow-md shadow-primary/20 transition-transform duration-300 group-hover:scale-105">
