          ...
          <div className="col-span-4 border-r border-slate-200/80 dark:border-slate-800/80 pr-8 flex flex-col gap-4 justify-between">
            {promoCards.map((card, idx) => (
              <Link
                ...
                onClick={onClose}
                className="group/card relative flex items-center gap-4 p-4 rounded-2xl bg-gradient-to-br from-slate-50/90 via-slate-50/40 to-indigo-500/[0.03] dark:from-slate-900/60 dark:via-slate-900/30 dark:to-indigo-500/[0.05] border border-slate-200/80 dark:border-slate-800/80 hover:border-indigo-500/40 transition-all duration-300 shadow-2xs hover:shadow-lg overflow-hidden"
              >
