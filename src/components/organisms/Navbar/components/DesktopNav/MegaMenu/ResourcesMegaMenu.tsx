              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isCardActive
                      ? "bg-blue-50/60 dark:bg-blue-950/30 border-blue-500/40 shadow-xs"
                      : "bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 hover:border-blue-500/40 hover:bg-slate-50/50 dark:hover:bg-slate-850"
                  )}
                >
                  ...
                  <div className="flex-1 space-y-1 min-w-0">
                    <div className="flex items-center gap-1.5">
                      ...
                      {isCardActive && (
                        <span className="text-[8px] font-black uppercase tracking-widest bg-blue-600 text-white px-1.5 py-0.2 rounded-full">
                          Current
                        </span>
                      )}
                    </div>
