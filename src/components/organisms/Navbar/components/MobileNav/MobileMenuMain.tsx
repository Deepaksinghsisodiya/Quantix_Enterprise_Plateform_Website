            ...
            {token ? (
              ...
              <>
                <button
                  ...
                  className="flex h-11 cursor-pointer items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#FF4F00] to-[#FF6B2B] text-[13px] font-syne font-extrabold uppercase tracking-normal text-white shadow-lg shadow-orange-500/25 transition-all duration-200 hover:brightness-110 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500/30"
                >
                  <Sparkles size={15} className="text-amber-200 fill-amber-200" />
