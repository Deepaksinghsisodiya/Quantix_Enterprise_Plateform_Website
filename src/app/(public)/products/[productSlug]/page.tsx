...
const PRODUCT_SOLUTIONS: Record<string, ProductSolution> = {
  ...
  "cloud-pos": {
    slug: "cloud-pos",
    eyebrow: "Multi-Store Cloud Command & Telemetry",
    title: "Cloud Multi-Store POS & Central Control System",
    description:
      "Centralized cloud command center to control pricing, menus, real-time inventory sync, employee shift permissions, and consolidated branch analytics across all your locations.",
    points: [
      { title: "Central Menu & Price Push", desc: "Manage catalog pricing, store menus, combos, and promos across 50+ branches in one click." },
      { title: "Live Multi-Store Telemetry", desc: "View real-time sales revenue, cashier throughput, and hourly branch traffic from anywhere." },
      { title: "Automated Financial & ERP Sync", desc: "Export daily financial ledgers, tax reports, and inventory valuations to QuickBooks, Xero, or ERPs." },
    ],
    workflows: [
      { title: "Consolidated Multi-Store Dashboard", desc: "Compare hourly branch revenue, average ticket size, and labor costs across all outlets in real time." },
      { title: "Instant Central Catalog Syndication", desc: "Deploy price adjustments, new items, and seasonal promotions to all connected registers in seconds." },
      { title: "Inter-Branch Stock Balancing & Transfers", desc: "View stock levels across all locations and initiate tracked stock transfers between stores and warehouses." },
      { title: "Enterprise Role Permission Matrices", desc: "Define granular access controls and PIN overrides for cashiers, store managers, and regional supervisors." },
      { title: "Automated Daily Financial Ledgers", desc: "Generate automated end-of-day X/Z summaries and sync journal entries directly to accounting software." },
      { title: "Real-Time Cloud Inventory Audits", desc: "Track raw ingredient and merchandise stock deductions across all terminals with discrepancy alert logs." },
    ],
    imageSrc: "/images/ent_franchise_portal.png",
    imageAlt: "Cloud POS multi-store control dashboard and telemetry",
    topBadge: "Multi-Store Cloud Control",
    bottomBadge: "Live Store Telemetry & Sync",
    ctaLabel: "Start Cloud Multi-Store Trial",
    icon: Cloud,
    faqs: [
      { id: "cloud-sync", question: "How fast do price and catalog updates reach store registers?", answer: "Catalog and pricing updates deploy in sub-second real time. Connected POS terminals receive updates without needing to restart." },
      { id: "cloud-offline", question: "Can store registers operate if the cloud connection goes offline?", answer: "Yes. Every register operates on an offline-first cache to keep checking out customers and printing receipts. All data syncs to the cloud automatically once internet reconnects." },
      { id: "cloud-reports", question: "Can I compare branch performance and export consolidated financials?", answer: "Yes. The central dashboard provides branch-by-branch comparisons, labor vs. revenue ratios, and automated exports to QuickBooks, Xero, and CSV." },
    ],
  },
  "enterprise-pos": {
    slug: "enterprise-pos",
