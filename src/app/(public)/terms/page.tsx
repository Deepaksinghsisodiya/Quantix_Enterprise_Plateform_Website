        ...
        <div className="site-container max-w-3xl space-y-12">
          ...
          <div className="space-y-8 text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium border-t border-gray-100 dark:border-slate-900 pt-8">
            <section className="space-y-3">
              <h2 className="text-sm font-syne font-bold uppercase tracking-tight text-slate-900 dark:text-white font-semibold">1. Acceptance of Terms</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-sm font-syne font-bold uppercase tracking-tight text-slate-900 dark:text-white font-semibold">2. Service Description</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-sm font-syne font-bold uppercase tracking-tight text-slate-900 dark:text-white font-semibold">3. Standalone Tokens</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-sm font-syne font-bold uppercase tracking-tight text-slate-900 dark:text-white font-semibold">4. Acceptable Code Conduct</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-sm font-syne font-bold uppercase tracking-tight text-slate-900 dark:text-white font-semibold">5. Limitations of Liability</h2>
              <p>
