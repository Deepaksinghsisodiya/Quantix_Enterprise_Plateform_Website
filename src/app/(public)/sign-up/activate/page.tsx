        ...
        {isSuccess ? (
          <div className="text-center space-y-6">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl sm:text-3xl font-syne font-black text-white uppercase tracking-tight">
                Account Active!
              </h2>
            ...
            <div className="bg-slate-950/60 rounded-2xl p-6 border border-slate-800 text-left space-y-4">
              <h4 className="text-[10px] font-bold uppercase tracking-wider text-slate-500 border-b border-slate-800 pb-2">
                Onboarding Steps Status
              </h4>
              <div className="space-y-3">
                {steps.map((st: any, idx: number) => (
                  <div key={idx} className="flex items-center gap-3">
                    <div className="h-5 w-5 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 flex-shrink-0">
          ...
          <div className="text-center space-y-6 py-8">
            <div className="h-12 w-12 rounded-full border border-slate-800 flex items-center justify-center mx-auto text-slate-400 animate-spin border-t-blue-500" />
            <div className="space-y-1">
              <h3 className="text-lg font-bold text-white uppercase font-syne">Activating Profile...</h3>
              <p className="text-xs text-slate-400">Verifying credential tokens and preparing secure billing services.</p>
            </div>
          </div>
        )}
      </motion.div>
