...
const DEFAULT_RESOURCES: ResourceDto[] = [
  { id: '1', title: 'The 2026 State of Enterprise Technology Report', type: 'whitepaper', topic: 'industry', description: 'Comprehensive analysis of POS, cloud HQ, and automation trends shaping enterprise commerce networks.', thumbnailUrl: '/images/prod_enterprise_hub.png', downloadUrl: '#', publishedAt: '2026-04-01', isGated: true },
  { id: '2', title: 'ERP & POS Migration Checklist', type: 'checklist', topic: 'operations', description: 'Step-by-step guide to switching enterprise POS networks with zero transactional downtime.', thumbnailUrl: '/images/prod_inventory_sync.png', downloadUrl: '#', publishedAt: '2026-04-01', isGated: false },
  { id: '3', title: 'Getting Started with Multi-Store POS', type: 'ebook', topic: 'standalone', description: 'Everything you need to know about hybrid cloud & offline POS architecture — from pilot to global rollout.', thumbnailUrl: '/images/pos_counter_3d.png', downloadUrl: '#', publishedAt: '2026-04-01', isGated: true },
  { id: '4', title: 'The Multi-Location POS Playbook', type: 'whitepaper', topic: 'enterprise', description: 'Strategies for managing master catalogs, central supply chains, and role-based permissions across branches.', thumbnailUrl: '/images/hero_multi_location_hq.jpg', downloadUrl: '#', publishedAt: '2026-04-01', isGated: true },
  { id: '5', title: 'Mastering Enterprise Supply Chain & Inventory', type: 'webinar', topic: 'operations', description: 'Recorded technical deep-dive on real-time stock sync, warehouse replenishment, and COGS audits.', thumbnailUrl: '/images/retail_stockroom_inventory.jpg', downloadUrl: '#', publishedAt: '2026-04-01', isGated: false },
  { id: '6', title: 'Enterprise Omnichannel Buyer\'s Guide 2026', type: 'ebook', topic: 'industry', description: 'Compare SLA guarantees, ERP data lakes, and hardware peripherals for multi-brand groups.', thumbnailUrl: '/images/retail_pos_analytics_bi.jpg', downloadUrl: '#', publishedAt: '2026-04-01', isGated: true },
];
