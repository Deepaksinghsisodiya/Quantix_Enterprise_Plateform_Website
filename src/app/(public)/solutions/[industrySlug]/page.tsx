...
const INDUSTRIES_DATA: Record<string, IndustrySolution> = {
  "fine-dining": {
    ...
    imageSrc: "/images/industries/fine_dining_enterprise.png",
  ...
  "quick-service": {
    ...
    imageSrc: "/images/industries/qsr_kiosk_enterprise.png",
  ...
  "cafe-bakery": {
    ...
    imageSrc: "/images/solutions/solution_cafe_bakery.png",
  ...
  "electronics": {
    ...
    imageSrc: "/images/industries/venues_stadium_enterprise.png",
