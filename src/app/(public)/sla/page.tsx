        ...
        <div className="site-container max-w-3xl space-y-12">
          ...
          <div className="space-y-8 text-xs text-slate-400 leading-relaxed font-medium border-t border-slate-900 pt-8">
            <section className="space-y-3">
              <h2 className="text-sm font-syne font-bold uppercase tracking-tight text-white font-semibold">1. Uptime SLA Commitments</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-sm font-syne font-bold uppercase tracking-tight text-white font-semibold">2. Standalone Support</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-sm font-syne font-bold uppercase tracking-tight text-white font-semibold">3. Compensation Criteria</h2>
              <p>
